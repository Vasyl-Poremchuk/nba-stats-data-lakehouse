...
def run() -> None:
    ...
    for object_metadata in objects_metadata:
        ...
        team_stats_dyf = team_stats_etl.get_dyf(
            df=team_stats_df,
            glue_context=glue_context,
            db_name=db_name,
            table_name=table_name,
        )
        passed_team_stats_df, failed_team_stats_df = (
            team_stats_etl.evaluate_dyf(
                dyf=team_stats_dyf,
                dq_rules=dq_rules,
                db_name=db_name,
                table_name=table_name,
